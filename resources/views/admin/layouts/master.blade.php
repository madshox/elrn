...
<head>
    ...
    <link rel="apple-touch-icon"
          href="{{ asset('admin/app-assets/images/portrait/small/avatar-s-7.jpg') }}app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon"
          href="{{ asset('admin/app-assets/images/portrait/small/avatar-s-7.jpg') }}app-assets/images/ico/favicon.ico">
